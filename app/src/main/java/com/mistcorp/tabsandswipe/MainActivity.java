package com.mistcorp.tabsandswipe;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static class FirstActivity extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            View rootView = inflater.inflate(R.layout.first_tub, container, false);
    ...
    public static class SecondActivity extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            View rootView = inflater.inflate(R.layout.second_tub, container, false);
    ...
    public static class ThirdActivity extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            View rootView = inflater.inflate(R.layout.third_tub, container, false);
